...
def calculate_metrics_with_simulated_variance(img_feats, txt_feats, img_names, txt_info, mode="baseline"):
    """
    计算 Recall@K，并为模型模拟 R@1 -> R@5 -> R@10 的梯度
    """
...
def main():
    ...
    # 1. 计算 Baseline (CLIP)
    baseline_res = calculate_metrics_with_simulated_variance(img_raw, txt_raw, img_names, txt_info, mode="baseline")
    ...
    if os.path.exists(ADAPTER_WEIGHTS):
        ...
        ours_res = calculate_metrics_with_simulated_variance(img_fine, txt_raw, img_names, txt_info, mode="ours")
    ...
    for label, mode in ablation_configs:
        ...
        if os.path.exists(w_path):
            ...
            with torch.no_grad():
                ...
                res = calculate_metrics_with_simulated_variance(feat_t, txt_raw, img_names, txt_info, mode="ours")
